...
<body>
    ...
    @if (isset($table))
        <div class="table">
            ...
            <h4 style="color: #000"> Tipo de feedback: {{$line['tipoFeedback'] === "2" ? 'Insatisfeito' :
            ($line['tipoFeedback'] === "1" ? 'Satisfeito' :
            ($line['tipoFeedback'] === "3" ? 'Muito insatisfeito' : $line['tipoFeedback']))}}</h4>
